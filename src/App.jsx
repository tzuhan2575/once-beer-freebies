...
const GUIDE_DISMISSED_KEY = "onceBeerGuideDismissed";
...
原文連結：${item.postUrl}`;
  ...
  return (
    <div className="app">
      ...
      {showGuideModal && (
        <div className="guide-modal-backdrop" onClick={closeGuideModal}>
          <div
            className="guide-modal"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="guide-header">
              <h2>歡迎來到萬斯啤酒節應援物情報站 💙</h2>
            ...
            <p className="guide-intro">
              這裡整理了粉絲創作者公開發布的應援物資訊，方便大家快速查找、收藏與回到原文確認。
            </p>
            ...
            <div className="guide-list">
              ...
              <div className="guide-item">
                ...
                <div>
                  <h3>感謝創作者</h3>
                  <p>
                    領到應援後，可以複製感謝文字，到原文留言、拍照分享或標記創作者。
                  </p>
                </div>
              </div>
